...
void Find(AwesomeArray & arr , int FindValue ){
    for(int i = 0; i < arr.length; i++) {
...
int main()
{
    ...
    while(true){
        ...
        cout << "enter command that you want(0 - add values, 1 - add one value , 2 - delete element, 3 - find index of value , 4 -  print, 5 - exit): ";
        cin >> command;
